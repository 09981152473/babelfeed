...
from ..utils.changeEpisodeFiles import change_ep_audio, change_ep_image
...
class Episode(models.Model):
    ...
    file_type = models.CharField(max_length=50, default="audio/mpeg")
    ...
    def process_ep_upload_data(self, request, show_data):
        audio_info = mutagen.File(self.audio).info
        self.play_length = str(int(audio_info.length))

        file_obj = request.FILES['audio']
        file_size = file_obj.size

        self.bit_size = file_size
        self.show_fk = show_data
