    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_fk', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='manage.show')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, null=True, upload_to=manage.models.episode.Episode.change_ep_image, validators=[manage.classes.filevalidator.FileValidator(content_types=('image/jpeg', 'image/png'))])),
                ('audio', models.FileField(null=True, upload_to=manage.models.episode.Episode.change_ep_audio, validators=[manage.classes.filevalidator.FileValidator(content_types=('audio/mpeg',))])),
